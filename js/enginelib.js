        ...
        tick: function () {
            ...
            if (this.x < -this.w) {
                ...
                if (record == 0) {
                    ...
                    this.y = this.dir === "up" ? h + 55 : h - this.h - 55;
                    record = 1;
                    rr = h;
                }
                else {
                    this.y = this.dir === "up" ? rr + 55 : rr - this.h - 55;
                    record = 0;
                }

                console.log(record, rr, this.y, this.dir);
            }
            return true;
        },
...
(function (engine) {
    ...
    engine.QL = engine.Class.extend({
        ...
        reward: function (r) {
            ...
            // console.log(r, this.alpha * (r + this.gamma * fr - Q[prevState][prevChoice]));
        ...
        getState: function () {
            ...
            dx1 = Math.floor(dx1 / this.resolution / 4) * this.resolution;
            dy1 = Math.floor(dy1 / this.resolution / 4) * this.resolution;

            dx2 = Math.floor(dx2 / this.resolution / 4) * this.resolution;
            dy2 = Math.floor(dy2 / this.resolution / 4) * this.resolution;
...
(function (engine) {
    ...
    engine.Game = engine.Class.extend({
        ...
        atlas: new engine.Atlas(url_path + 'res/flappyAtlas/atlas'),
